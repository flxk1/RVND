...
from rvnd.ingest import IngesterRegistry
from rvnd.ingest import Ingester
...
def test_policy_ingester_satisfies_protocol():
    from rvnd.adapters.ingest.governance import GovernanceIngester as PolicyIngester
