...
Run::
    ...
    python -m workspaces.mcp_server
...
# `workspaces.lock`) rather than user-driven — users wanted all tools from
...
def server_info(request: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        from workspaces.adapters.solver.loomground import LANGUAGE_VERSION as solver_language
