    ...
    return [
        ...
        RemediationAction(
            ...
            payload={
                ...
                "disclaimer_url": "https://workspaces.dev/disclaimer",
            },
        ),
    ]
...
# ===========================================================================
#
# The single-model Tier C in workspaces.lock/tier_c.py defers to the configured
...
def _models_for_role(
    ...
    host hook resolves ``workspaces.local_llm.resolve_models_for_role`` at
