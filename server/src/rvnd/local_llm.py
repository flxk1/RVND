...
def resolve_models_for_role(role: str) -> list[str]:
    ...
    Thin wrapper over :func:`rvnd.models_registry.models_for_role` so
    consumers that already import ``rvnd.local_llm`` don't have to also
    import the registry module. Used by ``rvnd.lock.core.tier_c_semantic_check``
