...
class WorkspaceMemory:
    ...
    def __init__(
        ...
        *,
        ...
        from :func:`rvnd.folder_context.current_folder` (the
        contextvar set by :class:`~rvnd.folder_context.folder_context`
        / :func:`~rvnd.folder_context.set_folder`, or the
        ``WORKSPACE_FOLDER_CONTEXT`` environment variable). If none can be
        determined and ``allow_unscoped`` is False, raises
        :class:`~rvnd.folder_context.NoFolderContextError`.
        """
