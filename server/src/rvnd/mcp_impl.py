...
from rvnd.adapters.solver.dimensions import Dimension, classify_predicate, classify_query_dimension
...
def lock_egress_check(
    ...
    0.6.7: delegates to the reference implementation in ``rvnd.lock.mcp_server``
    ...
    from rvnd.lock.mcp_server import egress_check as _lb_egress_check
...
def lock_ingress_check(
    ...
    """
    from rvnd.lock.mcp_server import ingress_check as _lb_ingress_check
...
def contract_tick(folder_context: str, as_of: str = "",
    ...
    try:
        ...
        from rvnd.adapters.solver.temporal import Date
