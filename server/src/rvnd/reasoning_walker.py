...
The contract (:mod:`rvnd.reasoning_contract`) says what a justified answer
must look like; the phases (:mod:`rvnd.reasoning_phases`) teach each step in
...
Division of labour, deliberately uneven:
  ...
  * **deterministic where possible** — norm retrieval comes from the rule
    ...
    assembly and gating go through :func:`rvnd.problem_kg.build_case`.
...
each oversight level is :data:`rvnd.reasoning_contract.INFORMATION_FORMS`.
"""
