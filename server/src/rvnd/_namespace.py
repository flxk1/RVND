...
``rvnd.mutation_log.open_folder()`` for the workspace-level migration.
...
def _write_migration_event() -> None:
    ...
    try:
        ...
        from rvnd.mutation_log import LOG_ROOT_DEFAULT, append_event
